...
#define RBFM_INSERT_FAILED 9
#define RBFM_UPDATE_FAILED 10
...
private:
  ...
  unsigned totalPage_nr;
  unsigned totalSlot_nr;
  unsigned currPage_nr;
  unsigned currSlot_nr;
...
private:
  ...
  void removeData(void * page, SlotDirectoryHeader slotHeader, SlotDirectoryRecordEntry recordEntry, unsigned slotNum);
  RC forwardingRecord(FileHandle &fileHandle, const vector<Attribute> & recordDescriptor, const RID &rid, const void * data);
